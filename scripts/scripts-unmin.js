...
function handleNavClick(event, target) {
  ...
  } else if (!['gitea-tab', 'about-tab', 'discord-tab', 'reddit-tab', 'terms-tab', 'privacy-tab', 'legal-info-tab', 'forum-tab'].includes(target.id)) {
...
function toggleSubmenu(target) {
  const isLegal = target.id === 'legal-tab'; // Prevents 32k items
